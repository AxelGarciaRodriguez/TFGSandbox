...
def make_all_transforms_image(kinect, config, depth_image, previous_min_depth, previous_max_depth, previous_depth=None):
    # GET PRINCIPAL APPLICATION VALUES
    ...
    if previous_depth is None or config_values[ConfigControllerEnum.RESET_IMAGE.name] or previous_min_depth != \
        ...
        last_depth_image = ImageTransformerDepth.set_data_between_distance(image=depth_image_transformed,
    ...
    return final_image, previous_depth, previous_min_depth, previous_max_depth
...
def projector_application(projector_screen, kinect, config: SharedConfig):
    ...
    final_image, previous_depth, previous_min_depth, previous_max_depth = make_all_transforms_image(
        kinect=kinect,
        config=config,
        depth_image=depth_image,
        previous_min_depth=previous_min_depth,
        previous_max_depth=previous_max_depth)

    # CREATE WINDOW SCREEN
    projector_screen.create_window_calibrate(window_name="Projector Window", image=final_image, fullscreen=True)
